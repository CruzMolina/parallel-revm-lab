...
- Status: real full-block trace pack for block `38014901` committed separately; full range not traced.
...
Do not cite this directory as a full-range analysis until a compact trace pack has been collected from a debug-capable Base RPC endpoint and the generated dossier has been reviewed for coverage, warnings, and provider limitations. Cite `case-studies/base-38014901-execution-dossier/` for the committed one-block real analysis.
