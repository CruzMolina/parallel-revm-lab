...
| mode | elapsed ns | synthetic tx/s | speedup vs sequential | declared conflicts | scheduler/validation metric |
| --- | ---: | ---: | ---: | --- | --- |
| sequential | 91,236,875 | 10,960.48 | baseline | 245 | input-order baseline |
| access-list | 28,106,333 | 35,579.17 | 3.246x | 245 | 245 deferrals; 4 waves, max width 793 |
| optimistic | 39,231,792 | 25,489.53 | 2.326x | 245 | 173 validation failures and re-executions |
