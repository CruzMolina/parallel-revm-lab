...
No compile-driven `revm` integration was attempted in this pass. Adding an adapter would require mapping EVM execution observations into this lab's `AccessKey` and `TxDelta` model without weakening the all-features build.
