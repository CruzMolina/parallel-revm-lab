...
| --- | ---: | ---: | --- | --- |
| sequential | 1,540,832.05 | baseline | true | state hash `ac90d19c91175700` |
| access-list | 16,767.11 | 0.011x | true | 309 waves; conservative scheduling overhead dominates this small batch |
| optimistic | 1,260,967.26 | 0.818x | true | 731 re-executions under observed contention |
